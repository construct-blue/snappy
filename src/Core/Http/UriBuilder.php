...
class UriBuilder
{
    ...
    public function withAddedParam(string $name, string $value): UriBuilder
    {
        return $this->withAppendedParams([$name => $value]);
    }
    ...
    public function withCurrentAsParam(string $param): UriBuilder
    {
        return $this->withAddedParam($param, (string)$this->withCurrentUri());
    }

    public function withRedirectParam(): UriBuilder
    {
        return $this->withCurrentAsParam('redirect');
    }

    public function withMatchedRoutePath(array $routeParams = []): UriBuilder
    {
        if ($this->routePathHelper->getRouteResult()->getMatchedRouteName()) {
            return $this->withRoute($this->routePathHelper->getRouteResult()->getMatchedRouteName(), $routeParams);
        }
        return $this->withCurrentUri();
    }
    ...
    {
        return rtrim($this->build()->__toString(), '/') ?: '/';
    }
}
