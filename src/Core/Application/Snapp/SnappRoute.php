...
class SnappRoute implements MiddlewareInterface
{
    ...
    public function setCode(?string $code): SnappRoute
    {
        $this->code = $code;
        return $this;
    }
    ...
    public function setName(?string $name): SnappRoute
    {
        $this->name = $name;
        return $this;
    }
    ...
    public function setSite(bool $site): SnappRoute
    {
        $this->site = $site;
        return $this;
    }
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        if ($this->matchUri($request->getUri())) {
            $ingressResult = new SnappRouteResult($this->snapp, $this->path, $this);
            ...
            return $handler->handle(
                $request->withAttribute(RouteResult::class, $routeResult)
                    ->withAttribute(SnappRouteResult::class, $ingressResult)
            );
        }
